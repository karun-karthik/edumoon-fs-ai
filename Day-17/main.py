...
# '''
# JS equivalent of greet function
# function greet() {
...
# print(my_list)
# my_list.pop() # remove element at last; pop(index)
# print(my_list)
# my_list.pop(2) # remove element at index 2
# print(my_list)
# my_list.insert(1, 10) # insert(index, value)
# print(my_list)
...
# print(set1.difference(set2))  # Difference of two sets' # common from both sets are removed and remaining are from set1
